(s => {
    ...
    return d.ajaxPrefilter ? d.ajaxPrefilter(function(e, t, s) {
        ...
        return "abort" === t ? (n[e] && n[e].abort(), n[e] = i.apply(this, arguments), n[e]) : i.apply(this, arguments)
    }), d
}), (s => {
    var e, t = (() => {
            try {
    ...
    var s = window.awsmJobs = window.awsmJobs || {},
        ...
        i = (s.submitApplication = function(n, e) {
            ...
            0 < c.length && c.each(function() {
                ...
                t.prop("disabled", !1).val(i).removeClass("awsm-application-submit-btn-disabled"), "undefined" != typeof grecaptcha && grecaptcha.reset()
            }))
    ...
    function e(e) {
        "selectric" in awsmJobsPublic.vendors && awsmJobsPublic.vendors.selectric && e.selectric({
            onInit: function(e, t) {
                var s = e.id;
                t && t.elements && t.elements.input && (t = f(t.elements.input), f(e).attr("id", "selectric-" + s), t.attr("id", s))
            },
    ...
    f(b + " .awsm-filter-option").on("change", function(e) {
        ...
        var t, s, i, n = f(this),
            ...
            p = (y(p) && (r = p.find(".awsm-filter-option").serializeArray()), a || (p = "", 1 < (i = (t = n.attr("href")).split("?")).length && (e = (s = new URLSearchParams(i[1])).get("paged"), s.delete("paged"), 0 < s.toString().length) && (p = "?" + s.toString()), r.push({
